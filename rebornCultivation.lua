...
local rmtev = ReplicatedStorage:WaitForChild("Events")
...
local function start()
    loopThread = task.spawn(function()
        while isRunning do
	FireRemote("CollectHerb", workspace:WaitForChild("Herbs"):WaitForChild("Spirit Grass"):WaitForChild("Spirit Grass"))
	FireRemote("CollectHerb", workspace:WaitForChild("Herbs"):WaitForChild("Ginseng2"):WaitForChild("Ginseng"))
	FireRemote("CollectHerb", workspace:WaitForChild("Herbs"):WaitForChild("Blood Flower"):WaitForChild("Blood Flower"))
	FireRemote("CollectHerb", workspace:WaitForChild("Herbs"):WaitForChild("Mesh3"):WaitForChild("Lotus"))
	FireRemote("CollectHerb", workspace:WaitForChild("Herbs"):WaitForChild("MoonLight"):WaitForChild("MoonLight Flower"))
	FireRemote("MineOre", workspace:WaitForChild("Ore"):WaitForChild("Iron"))
	FireRemote("MineOre", workspace:WaitForChild("Ore"):WaitForChild("Gold"))
	FireRemote("MineOre", workspace:WaitForChild("Ore"):WaitForChild("Ruby"))
	task.wait(0.1)
        end
    end)
end
...
zbtn5.MouseButton1Click:Connect(function(gameProcessed)
