...
zbtn5.MouseButton1Click:Connect(fireRemote("Main", unpack(crit)))
zbtn6.MouseButton1Click:Connect(fireRemote("Main", unpack(hp)))
zbtn7.MouseButton1Click:Connect(fireRemote("Main", unpack(def)))
zbtn8.MouseButton1Click:Connect(fireRemote("Main", unpack(atk)))
zbtn9.MouseButton1Click:Connect(fireRemote("Main", unpack(out)))
