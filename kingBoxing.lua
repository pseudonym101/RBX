...
zbtn12.Parent = zframe4
zbtn12.Position = UDim2.new(0,2,0,90)
...
zbtn13.Parent = zframe4
zbtn13.Position = UDim2.new(0,2,0,112)
...
zbtn8.MouseButton1Click:Connect(function()
    fireRemote("Main", unpack(crit))
end)
zbtn9.MouseButton1Click:Connect(function()
    fireRemote("Main", unpack(hp))
end)
zbtn10.MouseButton1Click:Connect(function()
    fireRemote("Main", unpack(def))
end)
zbtn11.MouseButton1Click:Connect(function()
    fireRemote("Main", unpack(atk))
end)
zbtn12.MouseButton1Click:Connect(function()
    fireRemote("Main", unpack(out))
end)
zbtn13.MouseButton1Click:Connect(function(input, gameProcessed)
