...
zbtn9.Name = "button9"
zbtn9.Parent = zframe
zbtn9.Position = UDim2.new(0,2,0,180)
...
local rmtev = game:GetService("ReplicatedStorage"):WaitForChild("RemoteEvent")
if not rmtev then
...
local function startSayingHi()
    loopThread = task.spawn(function()
        while isRunning do
            game:GetService("ReplicatedStorage"):WaitForChild("RemoteEvent"):WaitForChild("Main"):FireServer(unpack(auto))
            task.wait(0.1)
        end
    end)
end
...
zbtn5.MouseButton1Click:Connect(fireServer("Main", unpack(crit)))
zbtn6.MouseButton1Click:Connect(fireServer("Main", unpack(hp)))
zbtn7.MouseButton1Click:Connect(fireServer("Main", unpack(def)))
zbtn8.MouseButton1Click:Connect(fireServer("Main", unpack(atk)))
zbtn9.MouseButton1Click:Connect(fireServer("Main", unpack(out)))COREGUI = game:GetService("CoreGui")
Players = game:GetService("Players")
Workspc = game:GetService("Workspace")
Input = game:GetService("UserInputService")
...
zbtn7.MouseButton1Click:Connect(fireServer("Main", unpack(def)))
zbtn8.MouseButton1Click:Connect(fireServer("Main", unpack(atk)))
zbtn9.MouseButton1Click:Connect(fireServer("Main", unpack(out)))
