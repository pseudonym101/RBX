...
--tab3 btn
zbtn8.MouseButton1Click:Connect(ncc)
zbtn9.MouseButton1Click:Connect(nby)
zbtn10.MouseButton1Click:Connect(nbl)
zbtn11.MouseButton1Click:Connect(nct)